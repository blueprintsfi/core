...
contract BasketBlueprint is BasicBlueprint {
        ...
        )
    {
        ...
        (bool wrap, uint256[] memory ids, uint256[] memory amounts) = abi.decode(action, (bool, uint256[], uint256[]));
        ...
        return wrap ? (mintBurn, zero(), zero(), giveTake) : (zero(), mintBurn, giveTake, zero());
    }
}
