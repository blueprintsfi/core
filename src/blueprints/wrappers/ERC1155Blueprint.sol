...
contract ERC1155Blueprint is BasicBlueprint, ERC1155TokenReceiver {
    ...
    function getOperations(address erc1155, uint256[] memory ids, uint256[] memory amounts)
        internal
        pure
        returns (TokenOp[] memory ops)
    {
        ...
        )
    {
        ...
        return (zero(), getOperations(erc1155, ids, amounts), zero(), zero());
    }
}
